...
print(
    f"Msg Digest: {m.hexdigest()}\nMsg Digest Size: {m.digest_size}\nMsg Block Size: {m.block_size}"
)
# Validate the digest against CPython3 hashlib-md5
assert m.hexdigest() == "6a61334a5d9f848bea9affcd82864819", "Digest does not match expected string."
...
assert (
    m.hexdigest()
    == "7a12f0815f5511b8ba52c67922d1ae86dfd9bfcc4e0799ad89a9f01fc526c8f074ddb5948c06db9893536f2e65c7621b"  # noqa: E501
), "Digest does not match expected string."
...
assert (
    m.hexdigest()
    == "20a88a9b04aa490e457f8980e57331bc85c4d6ca30735a9e502f817e74011a9ece07078e53adf70c232ac91f6c79d4cd6cc69426cd77535645fe9016a71122c2"  # noqa: E501
), "Digest does not match expected string."
